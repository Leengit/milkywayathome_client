...
* 1. Plummer/Cored
* 2. Plummer/Cutoff-Cored
* 3. Plummer/Cutoff-NFW
* 4. Plummer/Hernquist
* 5. Plummer/NFW
* 6. Plummer/Plummer
* 7. King (single component)
* 8. Plummer/Einasto
*
...
int run_nbody_simulation(const char* dwarf_potential_type_lua, TestContext* tctx) {
	...
	if (strcmp(dwarf_potential_type_lua, "king_only.lua") != 0) {
		dwarf_params = default_params;
	} else {
		printf("\nUsing single component King model parameters...\n");
		dwarf_params = king_params;
	}
...
int main() {
	...
	{
		printf("\n=== SUMMARY ===\n");
		printf("Failed %d test(s) across all models\n", total_failed);
